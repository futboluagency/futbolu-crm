  ...
  return (
    <div style={{ fontFamily:"'Inter',system-ui,sans-serif",background:"#f5f0e8",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:20 }}>
      ...
      <div style={{ width:"100%",maxWidth:380,textAlign:"center" }}>
        ...
        <div style={{ background:"#ffffff",border:"1px solid #e8e3db",borderRadius:20,padding:"36px 32px" }}>
          <h1 style={{ fontSize:22,fontWeight:800,color:"#1a1a2e",marginBottom:8,letterSpacing:-0.5 }}>FUTBOLUAGENCY CRM</h1>
          <p style={{ fontSize:14,color:"#6b7280",marginBottom:32,lineHeight:1.6 }}>Inicia sesión con tu cuenta de Google para acceder al CRM.</p>
          <button onClick={handleLogin} disabled={loading} style={{ width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:12,padding:"13px 20px",borderRadius:12,border:"1px solid #e0dbd3",background:"#f5f0e8",color:"#1a1a2e",cursor:"pointer",fontSize:14,fontWeight:600,fontFamily:"inherit",transition:"all .15s" }}>
