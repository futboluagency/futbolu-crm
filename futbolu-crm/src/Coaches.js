          ...
          <div style={{ background:"#080a10", border:"1px solid rgba(255,255,255,0.08)", borderRadius:18, width:"100%", maxWidth:620, maxHeight:"92vh", overflowY:"auto", padding:24 }}>
            ...
            {emailModal.template&&<>
              ...
              <div style={{ display:"flex", gap:10, marginTop:12 }}>
                ...
                {emailModal.coach.email&&<a href={`mailto:${emailModal.coach.email}?subject=${encodeURIComponent(`${emailModal.coach.sport} Recruit – ${emailModal.player?.name||""}`)}&body=${encodeURIComponent(emailModal.template)}`} style={{ flex:1, padding:"10px", borderRadius:9, border:"1px solid rgba(16,185,129,0.3)", background:"rgba(16,185,129,0.08)", color:"#10b981", textDecoration:"none", fontSize:13, fontWeight:600, textAlign:"center", display:"flex", alignItems:"center", justifyContent:"center" }}>✉️ Abrir en Mail</a>}
              </div>
            </>}
          </div>
        </div>
